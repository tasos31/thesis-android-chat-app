...
public class TeamMessagesListFragment extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String  url = "http://" + GlobalDataSingleton.GLOBAL_ADDRESS
                + "/hatalink/GetTeamMessages?User1=" + GlobalDataSingleton.getInstance().getId()+"&TeamID="+GlobalDataSingleton.getInstance().getCurrTeamId();


        contentView = inflater.inflate(R.layout.messages_list_fragment,
                container, false);

        TextView teamNameTextView = (TextView) contentView.findViewById(R.id.team_name);

        teamNameTextView.setBackgroundResource(R.drawable.sign_in_rounded);

        teamNameTextView.setText(GlobalDataSingleton.getInstance().getCurrTeamName());
        ...
        FutureCallback<JsonObject> futureCallBack = new FutureCallback<JsonObject>() {
            ...
            public void onCompleted(Exception e, JsonObject result) {
                ...
                if (e == null) {
                    ...
                    // get the jsonArray
                    JsonArray jsonArray = result.get("TeamMessages").getAsJsonArray();
            ...
            if (v.getId() == R.id.send_message_button) {
                ...
                if (mSocket.connected()) {
                    ...
                    String url = "http://" + GlobalDataSingleton.GLOBAL_ADDRESS
                            ...
                            + "&teamID=" + GlobalDataSingleton.getInstance().getCurrTeamId()
                    ...
                    //
                     Log.i("receiver#############", GlobalDataSingleton.getInstance().getCurrTeamId());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSocket.emit("connect to room", GlobalDataSingleton.getInstance().getCurrTeamId(), GlobalDataSingleton.getInstance().getUsername());
    ...
    public void onDestroy() {
        ...
        mSocket.emit("chat message", obj);
        mSocket.emit("disconnect from room", GlobalDataSingleton.getInstance().getCurrTeamId());
        mSocket.disconnect();
